...
import com.impl.recoder.FileUtil;
...
public class AudioRecordDataSource {
    ...
    public void init(Context context) {
        audioFileDir = new File(FileUtil.getDiskCacheDir(context) + File.separator + RECORD_DIR_NAME);
        try {
            FileUtil.createDir(audioFileDir.getAbsolutePath());
            FileUtil.cleanDirectory(audioFileDir);
        } catch (IOException e) {
            e.printStackTrace();
        }
        initRecordFile();
