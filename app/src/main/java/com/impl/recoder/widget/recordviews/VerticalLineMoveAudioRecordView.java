...
public class VerticalLineMoveAudioRecordView extends BaseDrawAudioRecordView {
    ...
    protected void drawCenterVerticalLine(Canvas canvas) {
        ...
        centerLineX = circleX;
        float topCircleY = canvas.getHeight()/10*3;//ruleHorizontalLineHeight - middleCircleRadius;
        float bottomCircleY = canvas.getHeight() / 10*7;// canvas.getHeight() / 2 + (canvas.getHeight() / 2 - ruleHorizontalLineHeight) + middleCircleRadius;
